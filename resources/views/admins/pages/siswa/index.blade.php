        ...
        <div class="card card-default">
            <div class="card-header">
                <div class="card-title">
                    <div class="btn-group">
                        <a href="{{ route('siswa.create') }}" class="btn btn-primary btn-md"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-hovered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <a href="{{ route('siswa.edit', $value->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
